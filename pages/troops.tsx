    ...
    <>
      ...
      <ShopContainer> 
        ...
        <div className="divw">
          ...
          <div>
          <p><h6>current prize pool</h6></p>
          <h3><p>134.5 SOL</p> </h3>
          </div>
          <div>
          <p><h6>next royalties airdrop</h6></p>
          <h3><p>05 february</p> </h3>
          </div>
          <div>
          <p><h6>ending of p2e event</h6></p>
          <h3><p>22 february</p> </h3>
          </div>
          </div>
       <div className="flexdiv">
       
          <div className="flex1">
             <p><h6>how can I win $ape</h6></p>
          </div>
